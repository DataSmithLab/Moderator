...
class TaskVector():
    def __init__(self, pretrained_checkpoint=None, finetuned_checkpoint=None, vector=None, device=None, vector_path=None):
    ...
    def __neg__(self):
        ...
        with torch.no_grad():
            ...
            for key in self.vector:
                ...
                #print('original vector', self.vector[key])
                #print('neg vector', new_vector[key])
        return TaskVector(vector=new_vector)
