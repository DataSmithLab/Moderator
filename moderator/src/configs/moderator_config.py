...
class ModeratorConfig:
    def __init__(
        ...
        self.img_dir = "{work_id}/data/images".format(
            work_id=self.work_dir
        )
        self.finetuned_models_dir = "{work_id}/files/models_finetune".format(
            work_id=self.work_dir
        )
        self.edited_models_dir = "{work_id}/files/models_edited".format(
            work_id=self.work_dir
        )
